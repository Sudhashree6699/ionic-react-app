        ...
        {villaList.map((villa:any)=>{
            return(
                <IonCardHeader>
                    ...
                    <IonCardContent>{villa.title}</IonCardContent>
                    <IonCardContent color='danger'>{villa.price} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <IonButton size='small' color='danger'>More</IonButton> &nbsp; <IonButton size='small' color='danger'>Book villa</IonButton></IonCardContent>
                </IonCardHeader> 
            )
        })}
          <IonCardHeader>
